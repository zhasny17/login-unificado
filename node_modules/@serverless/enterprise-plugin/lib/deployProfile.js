...
const _require2 = require('./variables'),
      hookIntoVariableGetter = _require2.hookIntoVariableGetter;
...
function () {
  var _ref = _asyncToGenerator(function* (ctx) {
    ...
    hookIntoVariableGetter(ctx, _.fromPairs(deploymentProfile.secretValues.map(({
      secretName,
      secretProperties: {
        value
      }
    }) => [secretName, value])), accessKey);
  });
